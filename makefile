...
build: ## build environment and initialize composer and project dependencies
		...
		docker-compose run --rm php sh -lc 'xoff;COMPOSER_MEMORY_LIMIT=-1 composer install --ignore-platform-reqs'
...
composer-update: ## Update project dependencies
		docker-compose run --rm php sh -lc 'xoff;COMPOSER_MEMORY_LIMIT=-1 composer update --ignore-platform-reqs'
